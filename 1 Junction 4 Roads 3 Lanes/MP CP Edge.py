       ...
       # write the column header
         ...
         while traci.simulation.getTime() < simulation_duration:
            ...
            if current_time % phase_duration == 0:
                ...
                for edge in edges:
                    waiting_cars_edge = traci.edge.getLastStepVehicleNumber(edge)
